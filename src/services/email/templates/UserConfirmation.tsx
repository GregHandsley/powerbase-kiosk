      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={section}>
            ...
            {!isEdit && (
              <Text style={notice}>
                ⚠️ This booking was created after the notification window deadline.
                The bookings team will review it and may need to make adjustments.
              </Text>
            )}
            ...
            <Text style={footer}>
              If you have any questions or need to make changes, please contact the bookings team.
            </Text>
          </Section>
        </Container>
      </Body>
