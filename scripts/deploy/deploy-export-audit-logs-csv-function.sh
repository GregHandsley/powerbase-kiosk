...
# Script to deploy the export-audit-logs-csv Edge Function
# Run this after logging in to Supabase

echo "🚀 Deploying export-audit-logs-csv Edge Function..."
echo ""
...
npx supabase functions deploy export-audit-logs-csv
