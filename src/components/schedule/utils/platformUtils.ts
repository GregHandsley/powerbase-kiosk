 ...
 */
export function getAvailablePlatformsFromLayout(layout: RackRow[]): PlatformOption[] {
  return layout
 ...
 */
export function getAvailablePlatformsForSide(side: "power" | "base"): PlatformOption[] {
  if (side === "power") {
