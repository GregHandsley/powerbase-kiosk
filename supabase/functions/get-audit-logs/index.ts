// Edge Function: Get Audit Logs (server-only)
// Provides read access to audit logs with authorization and filtering
//
// Usage: Called from admin UI to view audit logs
...
//   siteId?: number;
//   search?: string; // Simple string match on metadata or entity_id
//   limit?: number; // Default 50
//   cursorCreatedAt?: string; // ISO 8601 timestamp
...
serve(async (req) => {
  ...
  try {
    ...
    // Build next cursor
    let nextCursor: GetAuditLogsResponse['nextCursor'] = null;
